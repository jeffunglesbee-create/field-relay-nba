...
export const ROUTE_PROVENANCE_GENERATED_AT = "2026-09-13T04:02:26.787Z";
export const ROUTE_PROVENANCE = {
  ...
  "/analytics/morning-report/recompute": { k: "trigger", s: "d1:ARCHIVE_DB + kv:FIELD_JOURNALISM" },
  ...
  "/archive/score-by-id": { k: "store", s: "d1:ARCHIVE_DB" },
  ...
  "/audio/tts": { k: "computed", s: "ai:AI" },
  "/backfill/brief-scores": { k: "trigger", s: "d1:ARCHIVE_DB + field-claude-proxy.jeffunglesbee.workers.dev" },
  "/backfill/game-briefs": { k: "trigger", s: "d1:ARCHIVE_DB + field-claude-proxy.jeffunglesbee.workers.dev" },
  ...
  "/bsd/tennis/draw": { k: "upstream", s: "sports.bzzoiro.com" },
  ...
  "/cfl/standings": { k: "upstream", s: "cflscoreboard.cfl.ca" },
  "/cfl/stats/players": { k: "upstream", s: "cflscoreboard.cfl.ca" },
  "/cfl/stats/teams": { k: "upstream", s: "cflscoreboard.cfl.ca" },
  "/cfl/teams": { k: "upstream", s: "cflscoreboard.cfl.ca" },
  ...
  "/fantasy/ownership": { k: "upstream", s: "lm-api-reads.fantasy.espn.com" },
  ...
  "/health/sources": { k: "computed", s: "undeclared (computed; reads via a dispatch table, not statically followable)" },
  "/identity/mismatches": { k: "upstream", s: "api.the-odds-api.com + d1:ARCHIVE_DB + kv:FIELD_JOURNALISM" },
  "/identity/substitution-census": { k: "store", s: "d1:ARCHIVE_DB" },
  ...
  "/rss-proxy": { k: "computed", s: "caller-supplied (computed; fetches the URL given in the request)" },
  "/savant/sync": { k: "store", s: "d1:ARCHIVE_DB" },
  "/schedule/ai-fallback": { k: "upstream", s: "field-claude-proxy.jeffunglesbee.workers.dev + kv:FIELD_JOURNALISM" },
  "/session/record": { k: "store", s: "d1:ARCHIVE_DB" },
  "/signal/crunch/": { k: "durable-object", s: "do:GAME_DO", p: 1 },
  ...
  "/test/combined-generate-judge": { k: "upstream", s: "field-claude-proxy.jeffunglesbee.workers.dev" },
  "/test/drama-score-cost": { k: "upstream", s: "api-web.nhle.com + cdn.nba.com + d1:WC2026_DB + do:BRACKET_DO + do:GAME_DO + espn-primary-forced-failure.invalid + kv:FIELD_JOURNALISM + kv:JOURNALISM_QUEUE + r2:FIELD_DATA + site.web.api.espn.com + sports.bzzoiro.com" },
  "/test/gemini-judge": { k: "upstream", s: "field-claude-proxy.jeffunglesbee.workers.dev" },
  "/test/prefilter": { k: "computed", s: null },
  "/test/workers-ai-judge": { k: "computed", s: null },
  "/unpin/game/": { k: "durable-object", s: "do:GAME_DO", p: 1 },
  "/user/": { k: "durable-object", s: "do:USER_DO", p: 1 },
  "/user/event": { k: "computed", s: "do:USER_DO (inherited from the enclosing block)" },
  "/v2/": { k: "upstream", s: "api-web.nhle.com + api.squiggle.com.au + api.the-odds-api.com + cdn.nba.com + d1:ARCHIVE_DB + d1:WC2026_DB + do:BRACKET_DO + do:GAME_DO + espn-primary-forced-failure.invalid + kaliaflstats.com + kv:FIELD_JOURNALISM + kv:JOURNALISM_QUEUE + r2:FIELD_DATA + site.web.api.espn.com + sports.bzzoiro.com", p: 1 },
  "/v2/games": { k: "upstream", s: "api-web.nhle.com + api.squiggle.com.au + api.the-odds-api.com + cdn.nba.com + d1:ARCHIVE_DB + d1:WC2026_DB + do:BRACKET_DO + do:GAME_DO + espn-primary-forced-failure.invalid + kaliaflstats.com + kv:FIELD_JOURNALISM + kv:JOURNALISM_QUEUE + r2:FIELD_DATA + site.web.api.espn.com + sports.bzzoiro.com" },
  ...
  "/wc/elimination-traps": { k: "store", s: "kv:FIELD_JOURNALISM" },
